...
+ (NSString *) webScriptNameForSelector:(SEL)sel {
    if (sel == @selector(get:)) {
        ...
        return @"showSaveDialog";
    }else if(sel == @selector(getPrinters:)){
        return @"getPrinters";
    }else if(sel == @selector(getPrinterDescription:)){
        return @"getPrinterDescription";
    }else if(sel == @selector(printPDFwithPrinter:andData:)){
        return @"printPDF";
    }
    return nil;
}
...
- (NSString *) getPrinterDescription:(NSString *)name{
